...
sudo apt -y install nano build-essential git python3-dev gcc debconf locales fonts-hack-ttf htop wget nmap node wget gnupg
...
brew install bat glances mcfly thefuck git-lfs
